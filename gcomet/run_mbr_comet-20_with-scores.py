...
"""
Run MBR Decoding with COMET-20 and Write Scores to JSON File
============================================================
The MBR implementation by Chantal Amrhein is modified in 
order that each candidate and its average score are saved 
in a json file. 
